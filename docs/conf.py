...
latex_documents = [
    (master_doc, 'Cechmate.tex', u'Cechmate Documentation',
     u'Chris Tralie and Nathaniel Saul', 'manual'),
]
...
man_pages = [
    (master_doc, 'cechmate', u'Cechmate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Cechmate', u'Cechmate Documentation',
     author, 'Cechmate', 'One line description of project.',
     'Miscellaneous'),
]
